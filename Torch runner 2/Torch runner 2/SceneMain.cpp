...
void CSceneMain::InitScene()
{
	...
	Draw::LoadImageW(L"Image\\back1.png", 1, TEX_SIZE_1024); //背景仮  1

	//外部グラフィックファイルを読み込み2番に登録(1024ピクセル)
	Draw::LoadImageW(L"Image\\back2.png", 2, TEX_SIZE_1024); //背景仮   2

	//外部グラフィックファイルを読み込み3番に登録(192ピクセル)
	Draw::LoadImageW(L"Image\\Fire Gauge.png", 3, TEX_SIZE_192);    //ゲージ
